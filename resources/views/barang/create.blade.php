                ...
                <div class="modal-body px-4 pt-3 pb-2">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-lg bg-light border-0" id="kode_barang" name="kode_barang" placeholder="PH.01.001" autocomplete="off" style="border-radius: 8px; font-size: 14px;">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 form-group mb-3">
