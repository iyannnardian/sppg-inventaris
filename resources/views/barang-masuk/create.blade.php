                            ...
                            <tbody id="containerBarisItem">
                                ...
                                <tr class="baris-item">
                                    ...
                                    <td>
                                        ...
                                        <input type="number" step="any" min="1" class="form-control input-qty" name="items[0][qty]" placeholder="0" required style="border-radius: 8px;" inputmode="decimal">
                                    </td>
                                    <td>
                                        <!-- HANYA ANGKA: inputmode numeric & JavaScript replace non-digit -->
                                        <input type="number" step="1" min="0" class="form-control input-harga" name="items[0][harga]" placeholder="0" required style="border-radius: 8px;" inputmode="numeric">
                                    </td>
